...
export default function Home() {
  ...
  // Parallax values - disabled for reduced motion
  ...
  const fadeUp = {
    hidden: { opacity: 0, y: shouldReduceMotion ? 0 : 30, z: 0 },
    visible: { 
      opacity: 1, 
      y: 0, 
      z: 0,
  ...
  const marqueeGenres = [
    ...
    { name: 'Romance', image: 'https://escapetoromance.com/wp-content/uploads/2017/05/iStock-503130452.jpg', color: 'from-pink-500 to-rose-600' },
    ...
    <main className="flex min-h-[calc(100vh-80px)] w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] -mt-6 -mb-6 flex-col overflow-hidden bg-black text-white">
      ...
      <section ref={heroRef} className="relative min-h-[100vh] flex flex-col items-center justify-center overflow-hidden">
        ...
        >
          ...
          {/* Optimized blob animations - GPU accelerated */}
          <motion.div 
            ...
            className="absolute top-[-20%] right-[-10%] w-[70vw] h-[70vw] rounded-full bg-[radial-gradient(circle,_rgba(59,130,246,0.15)_0%,_transparent_60%)] filter blur-[120px] gpu-accelerated transform-3d"
          ...
          <motion.div 
            ...
            className="absolute bottom-[-10%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-[radial-gradient(circle,_rgba(168,85,247,0.1)_0%,_transparent_60%)] filter blur-[100px] gpu-accelerated transform-3d"
            style={{ willChange: shouldReduceMotion ? 'auto' : 'transform' }}
          />
        </motion.div>
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col items-center max-w-5xl">
          ...
          >
            ...
            >
              <Button 
                asChild 
                className="group relative overflow-hidden bg-white text-black hover:text-black h-16 px-10 rounded-full font-bold text-lg transition-all hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(255,255,255,0.2)] gpu-accelerated"
          ...
          >
            {howItWorks.map((item, index) => (
              <motion.div
                key={item.step}
                variants={{
                  hidden: { opacity: 0, x: shouldReduceMotion ? 0 : -20, z: 0 },
                  visible: { 
                    opacity: 1, 
                    x: 0, 
                    z: 0,
                ...
                className="group relative flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-10 p-6 md:p-8 rounded-2xl bg-white/[0.01] border border-white/5 hover:border-emerald-500/30 hover:bg-emerald-500/[0.02] transition-colors gpu-accelerated"
              >
                ...
                <div className="hidden md:flex flex-shrink-0 items-center justify-center w-12 h-12 rounded-full bg-white/5 text-white/30 group-hover:text-emerald-400 group-hover:bg-emerald-500/10 transition-all gpu-accelerated">
          ...
          >
            ...
            <motion.div variants={fadeUp}>
              <Button 
                asChild 
                variant="outline" 
                className="rounded-full border-white/10 hover:bg-white/10 text-white gpu-accelerated"
              >
      ...
      <section className="relative py-32 bg-black border-t border-white/5 overflow-hidden">
        <div className="container mx-auto px-6 mb-16 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <Button 
              asChild 
              variant="outline" 
              className="rounded-full border-white/10 hover:bg-white/10 text-white w-fit gpu-accelerated"
            >
              <Link href="/genres">
        ...
        {/* Marquee Wrapper with fading edges - GPU accelerated */}
        <div 
        ...
        >
          <div className="flex w-max animate-marquee gap-6 px-6 transform-3d">
            {/* Double the list for infinite scrolling */}
            {[...marqueeGenres, ...marqueeGenres].map((genre, i) => (
              <Link 
                key={i} 
                href={`/genres?genre=${genre.name.toLowerCase()}`} 
                className="block group flex-shrink-0 w-[280px] md:w-[320px] gpu-accelerated"
              >
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <motion.div variants={fadeUp}>
              <Button 
                asChild 
                className="h-16 px-10 rounded-full font-bold text-lg bg-emerald-500 hover:bg-emerald-400 text-black border border-emerald-400/50 shadow-[0_0_30px_rgba(16,185,129,0.3)] transition-all hover:scale-105 active:scale-95 gpu-accelerated"
                style={{ willChange: 'transform' }}
              >
                <Link href="/create/ai-story">
